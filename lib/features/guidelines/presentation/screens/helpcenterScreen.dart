...
class _HelpCenterScreenState extends State<HelpCenterScreen> {
      ...
      body: BlocConsumer<GuidelinesBloc, GuidelinesState>(
        ...
        builder: (context, state) {
          ...
          if (state is GuidelinesLoadingState) {
            ...
            return buildInitialInput(helpCenter: state.guidelines.help);
  ...
  Widget buildInitialInput({required List<Help> helpCenter}) {
        ...
        children: [
          ...
          Padding(
            ...
            child: ListView.builder(
                itemCount: helpCenter[0].answer.length,
                shrinkWrap: true,
                        ...
                        child: ExpansionTile(
                          ...
                          title: Text(
                            getLanguageValueByKey(
                                helpCenter[0].question, language),
                            style: TextStyle(
                                fontSize: fontSize14,
